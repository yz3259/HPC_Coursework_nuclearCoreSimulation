subroutine bicgstab(M1,M2,S,F1,F2, FU1,FU2, sigma, maxit_inner, tau, u1,u2)
  !====================================
  ! Bicgstab algorithm
  ...
  P2%n = n; P2%ibeg = ibeg; P2%iend = iend
  ...
  call dcopy(n, FU1%xx, 1, R1%xx, 1)
  call dcopy(n, FU2%xx, 1, R2%xx, 1)    
  ! Copy residual to P1,P2
  call dcopy(n, R1%xx, 1, P1%xx, 1)
  call dcopy(n, R2%xx, 1, P2%xx, 1)
  ...
  do k=0,maxit_inner
     ...
     call dscal(n, beta, P1%xx, 1)
     call dscal(n, beta, P2%xx, 1)
